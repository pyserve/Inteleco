/*
  ...
  - Added the required column `image` to the `Demo` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Demo" ADD COLUMN     "image" TEXT NOT NULL;
